...
import eu.scape_project.pw.planning.xml.plan.TimestampFormatter;
...
/*    public static File exportTemplatesToFile(List<TemplateTree> trees) throws IOException {
    ...
    private void addCriterionInfo(Criterion criterion, Element parent) {
        ...
        if (prop != null) {
            ...
            addStringElement(propertyEl, "evaluationScope",  prop.getEvaluationScope() != null ? prop.getEvaluationScope().toString() : "");
