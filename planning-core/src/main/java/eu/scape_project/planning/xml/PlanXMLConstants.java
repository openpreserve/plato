...
/**
 * Provides constants for encoding, namespaces, schemas, and schema locations
 * for XML representations of preservation plans.
 * 
...
public class PlanXMLConstants {
    ...
    public static final String PLATO_SCHEMA_VERSION = "4.0.3";
