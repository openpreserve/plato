...
public class DominatedSetCalculator {
    ...
    // LoggerFactory.getLogger(DominatedSetCalculator.class);
    //
    ...
    // private HashMap<Criterion, Set<VPlanLeaf>> criterionVPlanLeaves = new
    // HashMap<Criterion, Set<VPlanLeaf>>();
    //
    // public DominatedSetCalculator(List<PlanInfo> selectedPlans,
    // List<VPlanLeaf> selectedVPlanLeaves) {
    ...
    // if (vPlanLeaf.getMeasure() != null) {
    // Set<VPlanLeaf> vPlanLeaves =
    // criterionVPlanLeaves.get(vPlanLeaf.getMeasure());
    //
    // if (vPlanLeaves == null) {
    // vPlanLeaves = new HashSet<VPlanLeaf>();
    // criterionVPlanLeaves.put(vPlanLeaf.getMeasure(), vPlanLeaves);
    // }
    ...
    // }
    //
    // public boolean isSubsetDominated(List<Criterion> allCriteria,
    // List<Criterion> criteriaList, int index) {
    //
    ...
    //
    // /**
    // * Checks if the provided criteria leaves are dominated. This is true if
    // for
    ...
    //
    // Map<PlanInfo, Set<VPlanLeaf>> planLeaves = new HashMap<PlanInfo,
    // Set<VPlanLeaf>>();
    //
    ...
    // * the sum of all changes this set of leaves can have in the worst case
    // for
    ...
    // * @return
    // */
    // private boolean isLeafSetDominated(PlanInfo planInfo, Set<VPlanLeaf>
    // vPlanLeafs) {
    ...
    // List<Double> sortResults = new
    // ArrayList<Double>(alternativePlanResults.values());
    ...
    // * @return
    // */
    // private double calculateMaximumChange(PlanInfo planInfo, Set<VPlanLeaf>
    // vPlanLeafs) {
    ...
    // * @return
    // */
    // private double calculateMaximumChange(PlanInfo planInfo, VPlanLeaf
    // vPlanLeaf) {
    //
    // if (vPlanLeaf.hasKOPotential()) {
    ...
    // Map<String, Double> alternativeCriterionResults =
    // vPlanLeaf.getAlternativeResultsAsMap();
    //
    ...
    // alternativeCriterionResults.entrySet()) {
    // if (entry.getKey().equals(planInfo.getWinningAlternative())) {
    // maximumDecrease = (entry.getValue() - vPlanLeaf.getPotentialMinimum()) *
    // vPlanLeaf.getTotalWeight();
    // } else {
    // double increase = (vPlanLeaf.getPotentialMaximum() - entry.getValue()) *
    // vPlanLeaf.getTotalWeight();
