...
public class PlanSettingsView implements Serializable {
	...
	@Inject	private PlanSettings planSettings;
	...
	@Inject private ProjectExportAction projectExport; 
	

	private String authPassword;
	
	/**
	 * Method responsible for returning if the publish report feature should be disabled or not.
	...
	/**
	 * Method responsible for resetting the publishReport flag in the plan if necessary.
	 * When the plan is not private the publishReport flag must not be set.
	 * For this reason - if publishReport it is not set we also have to disable the publishReport flag.
	 */
	 ...
	 * 
	 * @param event FileUploadEvent triggered form UI (containing all relevant data for report adding).
	 */
	...
	/**
	 * Method responsible for starting the plan-report download in the users web-browser.
	 */
	...
	/**
	 * Method responsible for activating action executions based on password authentication.
	 */
	...
	/**
	 * Method indicating if the logged in user user is allowed to modify given plan settings.
	 */
