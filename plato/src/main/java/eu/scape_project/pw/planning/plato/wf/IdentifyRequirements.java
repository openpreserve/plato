...
public class IdentifyRequirements extends AbstractWorkflowStep {
	...
	@Inject private ProjectExporter projectExporter;
     ...
     * 
     * @param Node to attach the Leaf to.
     ...
     * 
     * @param Node to attach the Node to.
    ...
    /**
     * Method responsible for retrieving a copy of a previously uploaded file including its data.
     * 
     * @param digitalObject DigitalObject stored in file system for which the data should be retrieved.
     ...
     * 
     * @param digitalObject Digital object to attach
     * @throws StorageException is thrown if any error occurs at storing the given file.
     */
     ...
     * 
     * @param digitalObject Digital object to remove.
     */
    ...
    /**
     * Method responsible for importing a requirements tree from a given FreeMind file.
     * 
     * @param file FreeMind file to import
     * @param includesUnits Indicates if the given FreeMind tree includes units
    ...
    /**
     * Method responsible for exporting the current requirements tree as FreeMind XML.
     * 
     * @return Current requirements tree in FreeMind XML representation. A String including the XML-data is returned.
     */
    ...
    /**
     * Method responsible for assigning a criterion to a defined leaf/requirement.
     * 
     * @param criterion Criterion to assign.
     * @param leaf Wanted leaf.
     */
     ...
     * @param leaf Leaf to detach the criterion from
     */
