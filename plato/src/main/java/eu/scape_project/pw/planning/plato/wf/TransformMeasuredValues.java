...
public class TransformMeasuredValues extends AbstractWorkflowStep {
    ...
    /**
     * Method responsible for approving transformer settings for the given leaves.
     * (Approval is done by touching the leaves transformer.)
     * 
     * @param leaves Leaves whose transformer settings should be approved.
     */
