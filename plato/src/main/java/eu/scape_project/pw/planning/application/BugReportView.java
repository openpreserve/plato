...
public class BugReportView implements Serializable {
	...
	/**
	 * Method called each time after the bean is created.
	 * This bean is generated based on the JSF2 ViewState scope.
	 */
	@PostConstruct
	public void init() {
	...
	/**
	 * Method responsible for sending a bug-report per mail based on the last reported error.
	 */
	public void sendBugReport() {
		...
		if (success) {
			facesMessages.addInfo("sendBugReport", "Bugreport sent. Thank you for your feedback. We will try to analyse and resolve the issue as soon as possible.");
		}
		else {
			facesMessages.addError("sendBugReport",
