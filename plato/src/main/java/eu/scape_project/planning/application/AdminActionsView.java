...
public class AdminActionsView implements Serializable {
	...
	public void exportAllPlansToZip() {
		...
		if (success) {
			facesMessages.addInfo("exportAllPlansToZip", "Exported successful to directory: " + adminActions.getLastProjectExportPath());
		}
		else {
	...
	public void exportSomePlansToZip() {
		...
		if (success) {
			facesMessages.addInfo("exportSomePlansToZip", "Exported successful to directory: " + adminActions.getLastProjectExportPath());
		}
		else {
	...
	/**
	 * Method responsible for clearing the list containing exception messages occured during Plato runtime.
	 */
	...
	/**
	 * Method responsible for importing Plans for the current logged in user, via a File.
	 */
	 ...
	 * 
	 * @param event RichFaces FileUploadEvent containing file information.
	 */
