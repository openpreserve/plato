...
public class SparqlResultComponentsParserTest {
	...
	public void testSuccessfulParsing() throws Exception{
		...
		Assert.assertEquals("http://www.myexperiment.org/workflows/2639", components.get(0).getUrl());
		Assert.assertEquals("Mock-Up mp3 To Wav Migrate And QA", components.get(0).getInfo());
		Assert.assertNotNull(components.get(0).getDescriptor());
	}
