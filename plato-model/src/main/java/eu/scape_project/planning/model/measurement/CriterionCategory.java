...
/**
 * This is based on the Preservation planning attributs and measures - Quality Model
 * 
 * @author kraxner
 *
 */
public enum CriterionCategory implements Serializable {
	TIME_BEHAVIOUR					("Action", "Action quality", "Performance efficiency", "Time behaviour", EvaluationScope.ALTERNATIVE_ACTION),
	RESOURCE_UTILIZATION			("Action", "Action quality", "Performance efficiency", "Resource utilization", EvaluationScope.ALTERNATIVE_ACTION),
	...
	INTEROPERABILITY				("Action", "Action quality", "Compatability", "Interoperability", EvaluationScope.ALTERNATIVE_ACTION),
	APPROPRIATENESS_RECOGNIZABILITY	("Action", "Action quality", "Usability", "Appropriateness recognizability", EvaluationScope.ALTERNATIVE_ACTION),
	...
	USER_ERROR_PROTECTION			("Action", "Action quality", "Usability", "User error protection", EvaluationScope.ALTERNATIVE_ACTION),
	USER_INTERFACE_AESTHETICS		("Action", "Action quality", "Usability", "User interface aesthetics", EvaluationScope.ALTERNATIVE_ACTION),
	...
	FUNCTIONAL_COMPLETENESS			("Action", "Action quality", "Functional suitability", "Functional completeness", EvaluationScope.OBJECT),
	FUNCTIONAL_CORRECTNESS_INFORMATION_PROPERTY("Action", "Action quality", "Functional correctness", "Functional correctness: Information Property", EvaluationScope.OBJECT),
	FUNCTIONAL_CORRECTNESS_TRANSFORMATIONAL_INFORMATION_PROPERTY("Action", "Action quality", "Functional correctness", "Functional correctness: Transformational Information Property", EvaluationScope.OBJECT),
	FUNCTIONAL_CORRECTNESS_REPRESENTATION_INSTANCE_PROPERTY("Action", "Action quality", "Functional correctness", "Functional correctness: Representation Instance Property", EvaluationScope.ALTERNATIVE_ACTION),
	FUNCTIONAL_APPROPRIATENESS		("Action", "Action quality", "Functional correctness", "Functional appropriateness", EvaluationScope.ALTERNATIVE_ACTION),
	...
	AUTHENTICITY_OF_THE_ACTION		("Action", "Action quality", "Security", "Authenticity of the action", EvaluationScope.ALTERNATIVE_ACTION),
	...
	FORMAT_SUSTAINABILITY			("Outcome", "Format of the content", "", "Format sustainability", EvaluationScope.ALTERNATIVE_ACTION),
	FORMAT_QUALITY_AND_FUNCTIONALITY("Outcome", "Format of the content", "", "Format quality and functionality", EvaluationScope.ALTERNATIVE_ACTION),
	FORMAT_BUSINESS_FACTORS			("Outcome", "Format of the content", "", "Format business factors", EvaluationScope.ALTERNATIVE_ACTION);
    ...
    private CriterionCategory(String topCategory, String subCategory, String subsubCategory, String criterionCategory, EvaluationScope scope) {
