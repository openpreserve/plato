...
/**
 * Transforms {@link OrdinalValue ordinal values} by defining a mapping from
 * their values to a numeric target value.
 * 
...
public class OrdinalTransformer extends Transformer {
     ...
     * complains. 'key' seems to be a keyword. We use a LinkedHashMap, to
     * preserve the order of the entries during ex-/import.
     */
     ...
     *             because this is the ordinal transformer.
     */
    ...
    /**
     * Returns the transformed value, i.e. the numeric target value
     * corresponding to the provided ordinal value according to the specified
     * {@link #mapping}.
     * 
     * @param v
    ...
    /**
     * Checks if all mappings are set and correctly specified, i.e. between 0.0
     * and 5.0. This is now a double-check as we already have a
     * {@link TargetValueValidator} that takes care of that. We still leave the
