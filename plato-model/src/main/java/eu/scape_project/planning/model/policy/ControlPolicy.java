...
/**
 * A control policy, which is of type {@link #controlPolicyType}, refers to a measure 
 * {@link #measure} which must/should ({@link #modality}) have a certain {@link #value}.
 * 
 * @author hku
 *
 */
public class ControlPolicy {
	...
	/**
	 * modality that describes whether the particular property-value pair is present or not.
	 */
